...
console.log(triangle.draw()); // drawing red color!
                              // triangle

console.log(rectangle.getArea()); // 400
console.log(triangle.getArea()); // 200

// 6. Class checking: instanceOf // 왼쪽의 object가 오른쪽의 class를 이용해 만들어진 것인지 아닌지 확인 boolean 리턴
console.log(rectangle instanceof Rectangle); // true
console.log(triangle instanceof Rectangle); // false
console.log(triangle instanceof Triangle); // true
console.log(triangle instanceof Shape);  // true Shape에서 상속받았으니까
console.log(triangle instanceof Object); // true 모든 obect와 class는 js의 Object를 상속한것
